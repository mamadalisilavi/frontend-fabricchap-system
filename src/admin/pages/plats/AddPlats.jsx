...
import ConfirmPage from './../../../components/chat/menu-chat/contents/ConfirmPage';
import Loading from "../../../components/Loading"
import { Link } from 'react-router-dom';
import NavSettings from "../../components/NavSettings"
import NavAdmin from "../../components/NavAdmin"

export default function AddPlats() {
  ...
  async function HandleSubmit(e) {
    ...
    if (click) {
      return await axios({
        method: "POST",
        url: process.env.REACT_APP_API_BASE_URL + "fileprint/storeForUser",
        headers: {
          ...
          <div className="">
            <div className={(confirm ? "hidden" : "") + " pr-[72px] md:pr-0"}>
                ...
                <select
                  ...
                  name="user"
                  id="user"
                  className="mb-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-4/5  md:w-full p-2.5"
                >
